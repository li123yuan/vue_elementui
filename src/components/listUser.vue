<template>
    <div>
        ...
        <el-table 
            ...
            <el-table-column prop="createtime" label="创建日期" :formatter="dateFormat" sortable></el-table-column>
            <el-table-column prop="updatetime" label="更新日期" :formatter="dateFormat" sortable></el-table-column>
...
export default {
  ...
  methods: {
    listUser() {
      ...
      this.$http.get("/api/user/getAllUser").then(result => {
